...
This article mainly uses programming software R (@citeR) and other tools for data processing, visualization, and modeling analysis, such as "knit" [@knit], "here" [@here], "modelsummary" [@modelsummary], "tidyverse" [@tidyverse], "rstanarm"(@rstanarm).
